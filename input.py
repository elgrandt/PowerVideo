...
pygame.font.init()
ubuntu_bold_graph = pygame.font.Font("fonts/Ubuntu-B.ttf",20)
ubuntu_bold_graph_initial = pygame.font.Font("fonts/Ubuntu-B.ttf",18)
...
class text_input:
    def __init__(self):
        ...
        self.lasttext = "Enter your text here"
        #color
        self.color = (0,0,0)
        #margin
        self.margin = 3
...
"""
    ...
    ### UPDATING FUNCTIONS ###
    def logic_update(self,pressed,mousex,mousey,keyboard):
        if (self.initial):
            font = self.initial_font
        ...
        #updating variable
        self.loops += 1
    def graphic_update(self,SCREEN,corrimiento):
        SCREEN.blit(self.surface,(self.X+corrimiento,self.Y))
